...
const STAGES = [
  ...
  },
  {
    ...
    plain: "A microscopic security camera embedded directly into the operating system kernel. It watches every encryption negotiation, invisibly and in real time, without affecting performance.",
